...
#define CONFIG_EXAMPLES_DIR "Tevo/Flash/V1 (MKS Base)"
...
#define STRING_CONFIG_H_AUTHOR "(André,Tevo Flash V1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "-=Ziburator=-"
